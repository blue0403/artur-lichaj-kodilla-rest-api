...
public class TrelloControllerTest {
    ...
    public void shouldCreateTrelloCard() throws Exception {
        ...
        TrelloTrelloDto trelloDto = new TrelloTrelloDto(2, 7);
        TrelloAttachmentsByTypeDto attachmentsByTypeDto = new TrelloAttachmentsByTypeDto(trelloDto);
        TrelloBadgesDto badges = new TrelloBadgesDto(9, attachmentsByTypeDto);
        ...
        mockMvc.perform(post("/v1/trello/cards")
                ...
                .andExpect(jsonPath("$.badges.votes", is(9)))
                .andExpect(jsonPath("$.badges.attachmentsByType.trello.board", is(2)))
                .andExpect(jsonPath("$.badges.attachmentsByType.trello.card", is(7)));
    }
}